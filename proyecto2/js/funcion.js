...
document.getElementById("demo12").innerHTML ="--------------"+ "<br>"+ "COMPRA SEMANA"+"<BR>"+ "---------------"+"</br>"+"compras del lunes "+ lunes+ "<br>"+"gasto realizados: "+ compra1+"<br>"+"<br>"+"</br>"+"<br>"+"<br>"+"<br>"+"TOTAL COMPRAS: "+  resultado;
